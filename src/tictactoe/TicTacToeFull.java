...
public class TicTacToeFull implements ActionListener {
...
//Setting up ALL the variables
    ...
    public TicTacToeFull() { //Setting game properties and layout and sytle...
...
//Adding to window and Showing window
    ...
    public static void main(String[] args) {
        new TicTacToeFull();// Calling the cl*** construtor.
// PROGRAM STARTS HERE!
    }
